...
public class MSimPhoneApp extends PhoneApp {
    ...
    public void onCreate() {
        ...
        if (phone == null) {
            ...
            Intent intent = new Intent(mContext, TelephonyDebugService.class);
            ...
            callerInfoCache = CallerInfoCache.init(this.mContext);
            ...
            am.registerMediaButtonEventReceiverForCalls(new ComponentName(mContext.getPackageName(),
    ...
    private void updatePhoneAppCdmaVariables(int subscription) {
        ...
        if ((msPhone != null) &&(msPhone.mPhone.getPhoneType() == Phone.PHONE_TYPE_CDMA)) {
    ...
    private void handleServiceStateChanged(Intent intent, Phone phone, int subscription) {
        ...
        if (ss != null) {
            ...
            notificationMgr.updateNetworkSelection(state, phone, subscription);
        }
    }
