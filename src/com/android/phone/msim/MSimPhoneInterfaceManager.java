...
public class MSimPhoneInterfaceManager extends ITelephonyMSim.Stub {
    ...
    public boolean isDataConnectivityPossible() {
        return getPhone(((MSimPhoneApp)mApp).getDataSubscription()).isDataConnectivityPossible();
    }
    ...
    public int getDataState() {
        return DefaultPhoneNotifier.convertDataState(
                getPhone(((MSimPhoneApp)mApp).getDataSubscription()).getDataConnectionState());
    }

    public int getDataActivity() {
        return DefaultPhoneNotifier.convertDataActivityState(
                getPhone(((MSimPhoneApp)mApp).getDataSubscription()).getDataActivityState());
    }
    ...
    public int getPreferredDataSubscription() {
        return ((MSimPhoneApp)mApp).getDataSubscription();
    }
